...
No prior programming experience is required. The live courses, asynchronous recordings, and myriad resources on the course site will assist you in ensuring you have a successful, fun experience learning geospatial analyses with various Python libraries. I will do my best to make this quarter with Python-based GIS a fruitful learning experience for you on your way to certification.  
